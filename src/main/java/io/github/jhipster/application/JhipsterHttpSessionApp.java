...
public class JhipsterHttpSessionApp {

    private static final Logger log = LoggerFactory.getLogger(JhipsterHttpSessionApp.class);

    private final Environment env;

    public JhipsterHttpSessionApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterHttpSession.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterHttpSessionApp.class);
